...
const EditLink = ({ editor, onRemoveLink, onEditLink, onEditLinkTitle, link: initLink, linkTitle }: EditLinkProps) => {
	...
	return (
		<Card className="w-80 flex flex-col p-1 gap-1 ">
			...
			<Separator />
			<Button variant={'ghost'} size={'sm'} leftSection={<Delete />} onClick={onRemoveLink}>
				Remove Link
			</Button>
		</Card>
	);
